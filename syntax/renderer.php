...
class syntax_plugin_admnote_renderer extends DokuWiki_Syntax_Plugin {
    ...
    public function postConnect() {
        // Allow nested admnote blocks by accepting a new <adm ...> while already
        // inside plugin_admnote_renderer mode.
        $this->Lexer->addEntryPattern('<adm ?[^>]*>', 'plugin_admnote_renderer', 'plugin_admnote_renderer');
        // Be tolerant with indentation/spaces around the closing tag, but do not
        // consume newlines from content (important for preserving "\\ " hardbreaks).
        $this->Lexer->addExitPattern('[ \t]*</adm\s*>', 'plugin_admnote_renderer');
    }
